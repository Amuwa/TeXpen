...
PDFJS.imageResourcesPath = './images/';
  ...
  PDFJS.cMapUrl = 'http://mozilla.github.io/pdf.js/web/cmaps/';
...
var SecondaryToolbar = {
  ...
  openFileClick: function secondaryToolbarOpenFileClick(evt) {
    //document.getElementById('fileInput').click();//wmc
    this.close();
  },
...
var PDFView = {
  ...
  set page(val) {
	//PDFFILE.Debug('setting page: '+val);
...
function webViewerInitialized() {
  ...
  //if (file) {
	//var pdfAsArray = convertDataURIToBinary(PDFFILE.getPDF());
	//PDFFILE.Debug('Yes');
